...
export const preEvaluationFormSchema = z.object({
  ...
  medicamentos: z.string().min(0, ""),
  alergias: z.string().min(0, ""),
  ...
  nivel_estresse: z.string().min(0, ""),
  questoes_emocionais: z.string().min(0, ""),
  impacto_qualidade_vida: z.string().min(0, ""),
  expectativas_tratamento: z.string().min(0, ""),
  exercicios_casa: z.string().min(1, "Exercícios em casa é obrigatório"),
  restricoes: z.string().min(0, ""),
  ...
  info_adicional: z.string().min(0, ""),
  duvidas_fisioterapia: z.string().min(0, ""),
});
