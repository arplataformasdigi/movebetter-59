...
interface PreEvaluationSummaryCardProps {
...
export function PreEvaluationSummaryCard({
  evaluation,
  onEdit,
  onDelete,
  onDownloadPDF,
}: PreEvaluationSummaryCardProps) {
  return (
    <Card>
      ...
      <CardContent className="pb-3 space-y-2">
        ...
        <div className="pt-2 border-t">
          <p className="text-xs text-muted-foreground">
            Clique em "Editar" para ver todos os detalhes
          </p>
        </div>
      </CardContent>
    </Card>
